...
import 'package:wcart/sub-categories/ProductFragment.dart';
import 'package:wcart/sub-categories/SubCategoryTwo.dart';

class SubCategoriesOne extends StatefulWidget{

  @override
  _SubCategoriesOneState createState() =>  _SubCategoriesOneState();
}

class  _SubCategoriesOneState extends State<SubCategoriesOne>{
          ...
          children: [
            ...
            GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  onClicked: () async {
                    Navigator.push(context,MaterialPageRoute(builder: (context) => ProductFragment()));
                  },
